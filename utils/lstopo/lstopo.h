...
extern output_method output_console, output_synthetic, output_ascii, output_fig, output_png, output_pdf, output_ps, output_nativesvg, output_cairosvg, output_x11, output_windows, output_xml, output_shmem, output_ios_draw;
...
extern void iosbox(int r, int g, int b, int x, int y, int width, int height, int gp_index, char *info);
extern void iostext(char *text, int gp_index, int x, int y, int fontsize);
extern void iosline(unsigned x1, unsigned y1, unsigned x2, unsigned y2);
extern void ios_prepare_scale(int width, int height);
